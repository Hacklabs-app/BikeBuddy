...
class OnboardingNotifier
    extends AutoDisposeAsyncNotifier<List<OnboardingPage>> {
  @override
  Future<List<OnboardingPage>> build() async {
    ...
    return const [
      OnboardingPage(
        ...
        subtitle: 'DISCOVER',
        description:
            'Find real-time bike availability at stations within walking distance.',
      ),
      OnboardingPage(
        title: 'Seamless Rental',
        subtitle: 'SCAN & GO',
        description:
            'No paper, no hassle. Show your unique QR code to start riding in seconds.',
      ),
      OnboardingPage(
        title: 'Ride Rewards',
        subtitle: 'LOYALTY',
        description:
            'Every minute counts. Unlock free rides and exclusive discounts as you pedal.',
      ),
    ];
  }
